...
resource "aws_subnet" "exam-subnet-1" {
...
resource "aws_subnet" "exam-subnet-2" {
  vpc_id            = aws_vpc.exam-vpc.id
...
resource "aws_subnet" "exam-subnet-3" {
  vpc_id            = aws_vpc.exam-vpc.id
...
resource "aws_default_route_table" "main-rtb" {
  default_route_table_id = aws_vpc.exam-vpc.default_route_table_id
  route {
